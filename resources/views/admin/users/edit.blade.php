...
@section('page_subtitle', 'Perbarui informasi dan kredensial akses anggota tim Anda.')
...
<div class="max-w-4xl mx-auto pb-20">
    ...
    <form action="{{ route('admin.users.update', $user) }}" method="POST" class="animate-in fade-in duration-700">
        @csrf @method('PUT')
        ...
        <div class="bg-white border border-slate-200 rounded-[2.5rem] p-8 md:p-12 shadow-sm space-y-10 relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center gap-4 border-b border-slate-100 pb-8">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400 font-medium">Lengkapi data pribadi dan kredensial akses untuk staf ini.</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                ...
                <div class="space-y-3">
                    <label class="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Password Baru <span class="text-slate-300 font-bold ml-1">(Opsional)</span></label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-5 pointer-events-none">
                    ...
                    <p class="text-[10px] text-slate-400 ml-2">Minimal 8 karakter. Biarkan kosong jika tidak ingin mengubah password lama.</p>
                </div>
            </div>
