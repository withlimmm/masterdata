                ...
                <div class="bg-white border border-slate-200 rounded-[2.5rem] p-8 md:p-10 shadow-sm space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea name="content" id="content" rows="20" required
                            class="w-full bg-slate-50 border border-slate-200 rounded-[2rem] px-6 py-6 text-base leading-relaxed focus:bg-white focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all outline-none resize-none">{{ old('content', $article->content) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-4 space-y-8">
                ...
                <div class="bg-white border border-slate-200 rounded-[2rem] p-8 shadow-sm space-y-6">
                    ...
                    <div class="relative group cursor-pointer" onclick="document.getElementById('cover_image').click()">
                        <div id="imagePreview" class="w-full aspect-[4/3] rounded-2xl bg-slate-50 border-2 border-slate-100 flex flex-col items-center justify-center text-slate-400 overflow-hidden transition-all hover:border-primary/50 group-hover:bg-slate-100/50">
