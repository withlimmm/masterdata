...
@section('title', 'Edit Sistem - Rakira CMS')
@section('page_title', 'Edit Sistem Langganan')
@section('page_subtitle', 'Perbarui informasi sistem untuk paket langganan.')
...
<div class="max-w-4xl mx-auto pb-20">
    ...
    <form action="{{ route('admin.systems.update', $system) }}" method="POST" class="animate-in fade-in duration-700">
        @csrf @method('PUT')
        ...
        <div class="bg-white border border-slate-200 rounded-[2.5rem] p-8 md:p-12 shadow-sm space-y-10 relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center gap-4 border-b border-slate-100 pb-8">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400 font-medium">Lengkapi informasi dasar untuk sistem langganan ini.</p>
                </div>
            </div>
                ...
                <div class="space-y-3 col-span-1 md:col-span-2">
                    ...
                    <div class="relative">
                        <textarea name="description" rows="3"
                            ...
                            class="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 text-sm focus:bg-white focus:ring-4 focus:ring-slate-800/10 focus:border-slate-800 transition-all font-medium outline-none text-slate-700 placeholder-slate-300">{{ old('description', $system->description) }}</textarea>
                    </div>
                </div>
            </div>
