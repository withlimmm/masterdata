...
@section('page_title', 'Edit Paket Langganan')
@section('page_subtitle', 'Perbarui batasan dan harga untuk paket langganan ini.')
...
<div class="max-w-4xl mx-auto pb-20">
    ...
    <form action="{{ route('admin.packages.update', $package) }}" method="POST" class="animate-in fade-in duration-700">
        @csrf @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                    ...
                    <div class="relative">
                        ...
                        <select name="system_id" required
                            ...
                            @foreach($systems as $sys)
                                <option value="{{ $sys->id }}" {{ old('system_id', $package->system_id) == $sys->id ? 'selected' : '' }}>
                ...
                <div class="space-y-3">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="package_code" value="{{ old('package_code', $package->package_code) }}" required
                ...
                <div class="space-y-3">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="package_name" value="{{ old('package_name', $package->package_name) }}" required
                ...
                <div class="space-y-3 col-span-1 md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="package_description" value="{{ old('package_description', $package->package_description) }}"
                ...
                <div class="space-y-3 col-span-1 md:col-span-2">
                    ...
                    <div class="relative">
                        <textarea name="package_benefits" rows="4"
                            ...
                            class="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 text-sm focus:bg-white focus:ring-4 focus:ring-slate-800/10 focus:border-slate-800 transition-all font-medium outline-none text-slate-700 placeholder-slate-300">{{ old('package_benefits', $package->package_benefits) }}</textarea>
                    </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="package_price" value="{{ old('package_price', $package->package_price) }}" required min="0"
